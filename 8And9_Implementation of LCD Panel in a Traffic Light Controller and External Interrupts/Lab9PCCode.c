...
void main(void)
{
    ...
    SW_MODE = volt < 3.0 ? 1:0;                 // Mode = 1, Day_mode, Mode = 0 Night_mode
    ADCON1 = 0x0F;
...
void update_misc()
{
    ...
    if (EMERGENCY_REQUEST == 0) EmergencyR_Txt[0] = '0'; 
    else EmergencyR_Txt[0] = '1';
    if (EMERGENCY == 0) EmergencyS_Txt[0] = '0'; 
    else EmergencyS_Txt[0] = '1';
...
void INT0_ISR()
{
    ...
    {
        INTCONbits.INT0IF=0;                // Clear the interrupt flag 
        NS_PED_SW = 0;                      // set software NS_PED_SW
    }
}
...
void INT1_ISR()
{
    ...
    {
        INTCON3bits.INT1IF=0;               // Clear the interrupt flag
        EW_PED_SW = 0;                      // set software EW_PED_SW
    }
}
...
void INT2_ISR()
{
    ...
    EMERGENCY_REQUEST = 1;                          // set software INT2_flag 
}
